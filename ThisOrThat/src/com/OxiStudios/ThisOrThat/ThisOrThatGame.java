...
import com.OxiStudios.ThisOrThat.Screens.AcheivementScreen;
...
public class ThisOrThatGame extends Game {
	...
	public AcheivementScreen achievementScreen;
	...
	public Vector2 word_position, point_position, score_position,
			pic_one_position, pic_two_position, timer_position;
	...
	public void create() {
		...
		word_position = new Vector2(SCREEN_WIDTH / 2f, SCREEN_HEIGHT - .225f
				* SCREEN_HEIGHT);
		...
		timer_position = new Vector2((.930f * SCREEN_WIDTH),
				.957f * SCREEN_HEIGHT);
